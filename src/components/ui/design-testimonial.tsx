...
const testimonials = [
  {
    quote: "Dennis transformed our digital presence with unmatched creativity.",
    author: "Sarah Chen",
    role: "Creative Director",
    company: "Studio Collective",
  },
  {
    quote: "The most elegant and thoughtful design solutions we've seen.",
    author: "Marcus Webb",
    role: "Brand Manager",
    company: "Minimal Co.",
  },
  {
    quote: "Pure craftsmanship meets innovative digital storytelling.",
    author: "Elena Frost",
    role: "Head of Design",
    company: "Future Labs",
  },
